...
EXPECTED_COLS = [
    "cdm_id","n_contigs","contig_n50","contig_l50","n_scaffolds","scaffold_n50","scaffold_l50",
    "n_component_sequences","gc_percent","n_chromosomes","contig_bp","checkm_completeness",
    "checkm_contamination","checkm_version"
    ]
