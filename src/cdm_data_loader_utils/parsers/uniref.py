...
def get_accession_and_seed(dbref: Optional[ET.Element], ns: Dict[str, str]) -> Tuple[Optional[str], bool]:
...
def parse_uniref_entry(
    ...
    """
    cluster_rows: List[Tuple[str, str, str, Optional[str], str]] = []
